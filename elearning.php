...
Schools in Ijapo Akure, Schools in Akure, High school, Elementary Schools in Akure" />
    ...
    <!-- Page Title -->
    <title>Lucie school intl.- elaerning</title>
            ...
            <div class="container">
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="thumb">
                                <img src="images/elearning.jpg" width="500px" alt="">
                            </div>
                        </div>
                        <div class="col-md-8 pl-5">
                            ...
                            bg-hover-theme-colored mb-30 p-30 pb-20">
                                <a class="media-left pull-left flip" href="#">
                                    <i class="fa fa-laptop text-theme-colored2"></i></a>
                                <div class="media-body">
                                    <h4 class="name font-30 mt-0 mb-0">E-LEARNING</h4>
