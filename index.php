          ...
          <div class="container">
              <div class="section-content">
                  <div class="row">
                      ...
                      <div class="col-md-8">
                          <h4 class="name font-30 mt-0 mb-0">RISE LIKE A PHOENIX  </h4>
                          <h5 class="mt-5">welcome</h5>
                          <p style="color: black">Lucie schools is  a structured, purposeful and caring learning
                              environment for all its students, within which each girl or boy can feel confident to explore,
                              ...
                              the children in their care.</p>
                          <p style="color: black">We aim to develop children as independent and life-long
                              learners who can respond to the challenges of a fast changing world.
                             We inspire every child forward in small achievable steps, and recognize
                              that assessment and target-setting are essential to this realizing their goals</p>

                          <a href="#" class="btn btn-dark btn-theme-colored1 btn-xl offset-4">Read More</a>
                      </div>
                  </div>
                  ...
                  <div class="row mt-30">
                      ...
                      <div class="col-md-4">
                          <div class="icon-box bg-white left media border-1px border-theme-colored2 bg-hover-theme-colored mb-30 p-30 pb-20">
                              ...
                              <div class="media-body">
                                  <h4 class="media-heading heading">Early years</h4>
                                  <p style="color: black">
                                      We admit childreen at early age for our creche and playgroup program.
                                      we Nurture self-esteem and develop confidence in these childreen
                                      with warmest love from professional care givers that
                                      understand the pscychology of early  years
                      ...
                      <div class="col-md-4">
                          <div class="icon-box bg-white left media border-1px border-theme-colored2 bg-hover-theme-colored mb-30 p-30 pb-20">
                              ...
                              <div class="media-body">
                                  <h4 class="media-heading heading">primary </h4>
                                  <p style="color: black">Our primary school education is exciting and engaging  as
                                      we build upon what each child knows,
                                      while developing the highest possible standards of Literacy, Numeracy and Investigative skills in each pupil </p>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-4">
                          <div class="icon-box bg-white left media border-1px border-theme-colored2 bg-hover-theme-colored mb-30 p-30 pb-20"> <a class="media-left pull-left flip" href="#"><i class="fa fa-university text-theme-colored2"></i></a>
                              <div class="media-body">
                                  <h4 class="media-heading heading">Secondary </h4>
                                  <p style="color: black">
                                      Our secondary School enables students to enjoy the benefits of evolving into their careers.
                                      We refine our curriculum throughout their formative years
                                      through a shared philosophy and ethos of academic excellence,to stir their potentials
                                      </p>
                              </div>
                          </div>
                      </div>
          ...
          <div class="container">
              <div class="section-content">
                  <div class="row">
                      ...
                      <div class="col-md-6">
                          <h2 class="line-bottom mt-0">Why we're <span class="text-theme-colored2">uinque</span></h2>
                          <div class="row">
                              <div class="col-md-12">
            ...
            <h2 class="text-theme-colored2 mt-0">we're rising like a phoenix</h2>
              ...
              <div class="event media mt-20 mb-10 no-bg no-border">
                <div class="event-date media-left pull-left flip">
                  <img src="images/icons/eduiconss-01.png" width="100px" class="img-circle img-thumbnail mt-5" alt="">
                </div>
              ...
              <div class="event media mt-20 mb-10 no-bg no-border">
                <div class="event-date media-left pull-left flip">
                  <img src="images/icons/eduiconss-02.png"  width="100px" class="img-circle img-thumbnail mt-5" alt="">
                </div>
                <div class="media-body pl-10">
                  <div class="event-content pull-left flip">
              ...
              <div class="event media mt-20 mb-10 no-bg no-border">
                <div class="event-date media-left pull-left flip">
                  <img src="images/icons/eduiconss-03.png"  width="100px" class="img-circle img-thumbnail mt-5" alt="">
                </div>
                <div class="media-body pl-10">
                  <div class="event-content pull-left flip">
            ...
            <div class="row">
              <div class="col-sm-12 mt-40">
                  <div>
                      ...
                      <div class="event media mt-20 mb-10 no-bg no-border">
                          <div class="event-date media-left pull-left flip">
                              <img src="images/icons/eduiconss-05.png"  width="100px" class="img-circle img-thumbnail mt-5" alt="">
                          </div>
                          <div class="media-body pl-10">
                              <div class="event-content pull-left flip">
                      ...
                      <div class="event media mt-20 mb-10 no-bg no-border">
                          <div class="event-date media-left pull-left flip">
                              <img src="images/icons/eduiconss-07.png"   width="100px" class="img-circle img-thumbnail mt-5" alt="">
                          </div>
                          <div class="media-body pl-10">
                              <div class="event-content pull-left flip">
        ...
        <div class="row mtli-row-clearfix">
          <div class="owl-carousel-3col">
              ...
              <div class="course-single-item style2 text-center mb-40">
                ...
                <div class="course-details bg-white border-1px clearfix p-15 pt-15">
                  ...
                  <div class="author-thumb">
                    <img src="images/course/xs1.jpg" alt="" class="img-circle img-thumbnail">
                  </div>
            ...
            <div class="item">
              <div class="course-single-item style2 text-center mb-40">
                ...
                <div class="course-details bg-white border-1px clearfix p-15 pt-15">
                  ...
                  <div class="author-thumb">
                    <img src="images/course/xs2.jpg" alt="" class="img-circle img-thumbnail">
                  </div>
                  <p class="course-description mt-5">Lorem ipsum dolor sit amet, consec teturadipsi cing elit. Nobis commodi esse aliquam eligend repreh</p>
                </div>
                <div class="course-meta bg-theme-colored">
            ...
            <div class="item">
              <div class="course-single-item style2 text-center mb-40">
                ...
                <div class="course-details bg-white border-1px clearfix p-15 pt-15">
                  ...
                  <div class="author-thumb">
                    <img src="images/course/xs3.jpg" alt="" class="img-circle img-thumbnail">
                  </div>
                  <p class="course-description mt-5">Lorem ipsum dolor sit amet, consec teturadipsi cing elit. Nobis commodi esse aliquam eligend repreh</p>
                </div>
                <div class="course-meta bg-theme-colored">
            ...
            <div class="item">
              <div class="course-single-item style2 text-center mb-40">
                ...
                <div class="course-details bg-white border-1px clearfix p-15 pt-15">
                  ...
                  <div class="author-thumb">
                    <img src="images/course/xs4.jpg" alt="" class="img-circle img-thumbnail">
                  </div>
                  <p class="course-description mt-5">Lorem ipsum dolor sit amet, consec teturadipsi cing elit. Nobis commodi esse aliquam eligend repreh</p>
                </div>
                <div class="course-meta bg-theme-colored">
            ...
            <div class="item">
              <div class="course-single-item style2 text-center mb-40">
                <div class="course-thumb">
                  <img class="img-fullwidth" alt="" src="images/course/sm5.jpg">
                ...
                <div class="course-details bg-white border-1px clearfix p-15 pt-15">
                  ...
                  <div class="author-thumb">
                    <img src="images/course/xs5.jpg" alt="" class="img-circle img-thumbnail">
                  </div>
                  <p class="course-description mt-5">Lorem ipsum dolor sit amet, consec teturadipsi cing elit. Nobis commodi esse aliquam eligend repreh</p>
                </div>
                <div class="course-meta bg-theme-colored">
            ...
            <div class="item">
              <div class="course-single-item style2 text-center mb-40">
                <div class="course-thumb">
                  <img class="img-fullwidth" alt="" src="images/course/sm6.jpg">
              ...
              <div class="icon-box bg-white left media border-1px border-theme-colored2 bg-hover-theme-colored mb-30 p-30 pb-20"> <a class="media-left pull-left flip" href="#"><i class="fa fa-book text-theme-colored2"></i></a>
                <div class="media-body">
                  ...
                  <p>Lorem ipsum dolor sit amet, consectetur
                      adipisicing elit. Cum consectetur sit ullam </p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-12">
              ...
              <div class="gallery-isotope default-animation-effect grid-4 masonry gutter-small clearfix" data-lightbox="gallery">
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img class="img-fullwidth" src="images/class.jpg" alt="project">
                    <div class="overlay-shade bg-theme-colored"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored2">
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img class="img-fullwidth" src="images/sporty%20(1).JPG" alt="project">
                    <div class="overlay-shade bg-theme-colored"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored2">
                          <a data-lightbox="image" href="images/gallery/m4.jpg"><i class="fa fa-plus"></i></a>
                          <a href="#"><i class="fa fa-link"></i></a>
                        </div>
                      </div>
                    </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img class="img-fullwidth" src="images/lprimary.jpg" alt="project">
                    <div class="overlay-shade bg-theme-colored"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored2">
