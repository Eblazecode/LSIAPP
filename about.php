...
<section style="background-color: #400c1b">
    <section class="container" >
        <div class="row mt-30">
            <div class="section-title text-center">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-uppercase line-bottom-double-line-centered mt-0" style="color: whitesmoke">Our
                            <span class="text-theme-colored2" style="color: whitesmoke">Core values</span></h2>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
