...
Schools in Ijapo Akure, Schools in Akure, High school, Elementary Schools in Akure" />
    ...
    <!-- Page Title -->
    <title>Lucie school intl.- mission</title>
            ...
            <div class="container">
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="thumb">
                                <img src="images/lucismwide.png" width="1000px" alt="">
                            </div>
                        </div>
                        <div class="col-md-8 pl-5">
                            ...
                            <div class="icon-box bg-white left media border-1px border-theme-colored2 bg-hover-theme-colored mb-30 p-30 pb-20"> <a class="media-left pull-left flip" href="#"><i class="fa fa-university text-theme-colored2"></i></a>
                                <div class="media-body">
                                    <h4 class="name font-30 mt-0 mb-0">OUR MISSION </h4>
                                    <h4 class="media-heading heading">Straight on the bull's eye</h4>
                                    <quote>Provide a safe,happy school in which care given high priority by dedicated staff
                                        ...
                                        High school
                                        Ourission is to develop young men and women with active and
                                        creative minds,a sence of understanding and compassion for others and encourage to act on their beliefs.
                                        We stress the total development of each child;spiritually,morally,i
                                        ntellectually,social,emotional and physical.</quote>
