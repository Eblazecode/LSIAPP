<header id="header" class="header modern-header modern-header-theme-colored" style="background-color: #a73131">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-md-6">
                    <div class="widget text-center">
                        <a class="" href="index.php"><img src="images/luciepng.png" width="60px" alt=""></a>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <div class="widget sm-text-center">
                    ...
                    <ul class="menuzord-menu">
                        ...
                        <li><a href="#">About</a>
                            <ul class="dropdown">
                                ...
                                <li><a href="mdwelcome.php">MD welcome</a></li>
                        ...
                        <li><a href="#">Academics</a>
                            <ul class="dropdown">
                                ...
                                <li><a href="library.php">library & programs</a></li>
                                <li><a href="elearning.php">e-learning</a></li>
                                <li><a href="excurricular.php">extracurricular</a></li>
                        ...
                        <li><a href="http://lucieschools.com/smart_school_src_version_6.1.0/site/login">PORTAL</a></li>
                                    ...
                                    <div class="col3">
                                        ...
                                        <article class="post clearfix">
                                            ...
                                            <div class="entry-content">
                                                <p class="">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do e
                                                    iusmod tempor incididunt ut labore et dolore magna et sed aliqua</p>
                        ...
                        <div class="widget pt-5" >
                            <ul class="list-inline  text-right flip sm-text-center">
                              <!--  <li class="m-0 pl-10"> <a href="ajax-load/login-form.html"
                                                          class="text-white ajaxload-popup"><i class="fa fa-user-o mr-5 text-white"></i> Login /</a> </li>
                                <li class="m-0 pl-0 pr-10">
                                    <a href="ajax-load/register-form.html" class="text-white
                                     ajaxload-popup"><i class="fa fa-edit mr-5 text-white"></i>Register</a>
                                </li>-->
                            </ul>
                        </div>
                    </ul>
