<section id="home" class="divider">
    <div class="container-fluid p-0">
        ...
        <div id="rev_slider_home_wrapper" class="rev_slider_wrapper fullwidthbanner-container"
             data-alias="news-gallery34" style="margin:0px auto;background-color:#ffffff;padding:0px;margin-top:0px;margin-bottom:0px;">
            ...
            <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
                <ul>
                    ...
                    <li data-index="rs-1" data-transition="slidingoverlayhorizontal"
                        ...
                        <!-- MAIN IMAGE -->
                        <img src="images/schbuiding.jpg" alt="" data-bgposition="top
                        40%" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                        ...
                        <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">welcome to <span class="text-theme-colored2">St.lucie school</span>
                        ...
                        <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index: 7; white-space: nowrap;">We're committed to wholesome education for the development of a total child
                            always<br>
                        </div>
                        <!-- LAYER NR. 4 -->
                        <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index: 7; white-space: nowrap;"><a href="#" class="btn btn-default btn-theme-colored2 btn-xl">Apply</a>
                    ...
                    <li data-index="rs-2" data-transition="slidingoverlayhorizontal"
                        ...
                        <!-- MAIN IMAGE -->
                        <img src="images/studying1.jpg" alt="" data-bgposition="center
                        ...
                        <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">We grow <span class="text-theme-colored2"> Future</span> leaders
                            <span class="text-theme-colored2">on </span> Excellence
                        </div>
                        <!-- LAYER NR. 4 -->
                        <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                             id="slide-2-layer-4"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index: 7; white-space: nowrap;"><a href="#" class="btn btn-dark btn-theme-colored2 btn-xl mt-5">Read More</a>
                        </div>
                        <!-- LAYER NR. 5 -->
                        <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                             id="slide-2-layer-5"
                    ...
                    <li data-index="rs-3" data-transition="slidingoverlayhorizontal"
                        ...
                        data-saveperformance="off" data-title="Make an Impact">
                        <!-- MAIN IMAGE -->
                        <img src="images/playgrnd.png" alt="" data-bgposition="top 30%"
                        ...
                        <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                             ...
                             white-space: normal;">With love and supportive
                            <span class="text-theme-colored2">Education</span> every child become their best
                        </div>
