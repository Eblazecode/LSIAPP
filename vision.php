                        ...
                        <div class="col-md-8 pl-5">
                                ...
                                <div class="icon-box bg-white left media border-1px border-theme-colored2 bg-hover-theme-colored mb-30 p-30 pb-20"> <a class="media-left pull-left flip" href="#"><i class="fa fa-university text-theme-colored2"></i></a>
                                    <div class="media-body">
                                        <h4 class="name font-30 mt-0 mb-0">OUR VISION </h4>
                                        <h4 class="media-heading heading">Lucie Elementary school</h4>
                                        <quote >Lucie Elementary school aim to enable every child regardless of the ability to
                                            ...
                                            community where children Excel in their achievements and inspired to continue learning.</quote>


                                        <quote>
                                            <h4 class="media-heading heading">Lucie high school</h4>

                                            To provide an excellent,balanced education in a nurturing and challenging
                                            learning environment producing confident world class student who strive to be the best</quote>
                ...
                <div class="section-title text-center">
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <h2 class="text-uppercase line-bottom-double-line-centered mt-0">Our
                                <span class="text-theme-colored2">Amazing school</span></h2>
